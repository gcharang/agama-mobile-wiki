...
Please make sure Bitcoin compatible coin is working in Agama mobile before making a PR. Pull requests containing partial information or not working assets/servers will remain unmerged until all requirements are fulfilled.